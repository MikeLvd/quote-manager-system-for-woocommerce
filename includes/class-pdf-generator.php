...
class Quote_Manager_PDF_Generator
{
    ...
    {
        // Make sure we have DOMPDF available
        ...
        if (!$quote_id || get_post_type($quote_id) !== 'customer_quote') {
            wp_die(__('Invalid quote ID.', 'quote-manager-system-for-woocommerce'));
        }
        ...
        if ($status === Quote_Manager_System_For_Woocommerce::STATUS_REJECTED) {
            wp_die(__('This quote has been rejected and is no longer available.', 'quote-manager-system-for-woocommerce'));
        }
        ...
        // Check if quote is signed and include signature if needed
        $is_signed = get_post_meta($quote_id, '_quote_pdf_is_signed', true) === '1';
        if ($is_signed) {
            // Set flag to include signature in the PDF
                    ...
                    <table>
                        <tr>
                            <td width="50%" style="vertical-align: middle;">
                                <?php if (!empty($company_logo)): ?>
                                    <img src="<?php echo esc_url($company_logo); ?>"
                                         alt="<?php echo esc_attr($company_name); ?>" class="company-logo">
                                <?php else: ?>
                            ...
                            <td width="50%" style="vertical-align: top; text-align: right;" class="company-info">
                                ...
                                <?php _e('Tel:', 'quote-manager-system-for-woocommerce'); ?> <?php echo esc_html($company_phone); ?>
                                <br>
                    ...
                    <table class="products-table">
                        ...
                        foreach ($products as $prod) {
                            ...
                            <tr>
                                ...
                                <td class="total-cell"><?php echo number_format($with_vat ? $line_total_with_vat : $line_total, 2, ',', '.'); ?>
                                    €
                                </td>
                            </tr>
                        <?php } ?>
                ...
                <div class="totals-area">
                    <table class="totals-table">
                        ...
                        <tr class="grand-total-row">
                            ...
                            <td class="grand-total-value"><?php echo number_format($subtotal + $total_tax, 2, ',', '.'); ?>
                                €
                            </td>
                        </tr>
                    </table>
                    ...
                    <div class="signature-area">
                        ...
                        if ($include_signature && !empty($customer_signature)):
                            ...
                            <div class="customer-signature">
                                <img src="<?php echo esc_attr($customer_signature); ?>"
                                     alt="<?php esc_attr_e('Customer Signature', 'quote-manager-system-for-woocommerce'); ?>">
                            </div>
                            <div class="signature-line"><?php _e('Customer Signature', 'quote-manager-system-for-woocommerce'); ?></div>
                        <?php else: ?>
        ...
        // Clean up the signature flag if we set it
        if ($is_signed) {

        ...
        switch ($column) {
            ...
            case 'email_tracking':
                ...
                if (!is_array($logs) || empty($logs)) {
                    echo '<span class="quote-tracking-status not-sent" data-tooltip="' . esc_attr__('Not sent yet', 'quote-manager-system-for-woocommerce') . '">—</span>';
                } else {
                    ...
                    if ($opened_count > 0) {
                        // Get the most recently opened log
                        ...
                        $tooltip = sprintf(
                            __('Sent %1$d time(s), opened %2$d time(s). Last opened: %3$s at %4$s', 'quote-manager-system-for-woocommerce'),
                            $sent_count,
                            $opened_count,
                            $formatted_date,
                            $formatted_time
                        ...
                        echo '<span class="quote-tracking-icon" data-tooltip="' . esc_attr($tooltip) . '">👁️</span>';
                    } else {
                        $tooltip = sprintf(__('Sent %d time(s) but not yet opened', 'quote-manager-system-for-woocommerce'), $sent_count);
                        echo '<span class="quote-tracking-icon faded" data-tooltip="' . esc_attr($tooltip) . '">👁️</span>';
                    }
                }
                break;
